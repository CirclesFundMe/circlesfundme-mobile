...
export default function ClientLayout() {
  return (
    <Stack>
      ...
      <Stack.Screen name="sign-up/personal-info" options={{ headerShown: false }} />
      <Stack.Screen name="sign-up/confirm-bvn" options={{ headerShown: false }} />
      <Stack.Screen name="sign-up/verify-identity" options={{ headerShown: false }} />
      <Stack.Screen name="sign-up/confirm-address" options={{ headerShown: false }} />
      <Stack.Screen name="sign-up/take-selfie" options={{ headerShown: false }} />
      <Stack.Screen name="sign-up/take-a-selfie-camera" options={{ headerShown: false }} />
